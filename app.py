...
def cat(strs):
    ...
    tspperday,waktuDatang = runcat.main(tourid,idhotel,dwaktu,drating,dtarif)
    dictionary = {}
    dictionary['day1'] = {}
    dictionary['day2'] = {}
    dictionary['day3'] = {}
...
def cuckoo(strs):
    ...
    dtarif = float(t_['degree'][2])
    drating = float(t_['degree'][1])
    tspperday,waktuDatang = runcuckoo.main(tourid,idhotel,dwaktu,drating,dtarif)
    dictionary = {}
    dictionary['day1'] = {}
    dictionary['day2'] = {}
    dictionary['day3'] = {}
...
def SA(strs):
    ...
    dtarif = float(t_['degree'][2])
    drating = float(t_['degree'][1])
    tspperday,waktuDatang = runSA.main(tourid,idhotel,dwaktu,drating,dtarif)
    dictionary = {}
    dictionary['day1'] = {}
    dictionary['day2'] = {}
    dictionary['day3'] = {}
